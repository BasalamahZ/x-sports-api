...
var (
	...
	// invalid.
	errInvalidNewsID = errors.New("INVALID_NEWS_ID")
	...
	// errInvalidImageNews is returned when the given
	// image news is invalid.
	errInvalidImageNews = errors.New("INVALID_IMAGE_NEWS")
...
var (
	...
	mapHTTPError = map[error]error{
		news.ErrInvalidTitle:       errInvalidTitle,
		news.ErrInvalidNewsID:      errInvalidNewsID,
		news.ErrInvalidGameID:      errInvalidGameID,
		news.ErrInvalidDescription: errInvalidDescription,
		news.ErrInvalidDate:        errInvalidDate,
		news.ErrInvalidImageNews:   errInvalidImageNews,
	}
)
